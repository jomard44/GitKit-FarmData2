...
export declare class PluginUninstallationManager {
    ...
    protected readonly onDidChangeDisabledPluginsEmitter: Emitter<readonly `${string}.${string}`[]>;
    onDidChangeDisabledPlugins: Event<readonly PluginIdentifiers.UnversionedId[]>;
    ...
    markAsDisabled(...pluginIds: PluginIdentifiers.UnversionedId[]): Promise<boolean>;
    markAsEnabled(...pluginIds: PluginIdentifiers.UnversionedId[]): Promise<boolean>;
    isDisabled(pluginId: PluginIdentifiers.UnversionedId): Promise<boolean>;
