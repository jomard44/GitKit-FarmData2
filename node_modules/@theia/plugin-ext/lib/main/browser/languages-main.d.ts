...
export declare class LanguagesMainImpl implements LanguagesMain, Disposable {
    ...
    protected createDocumentRangeSemanticTokensProvider(handle: number, legend: theia.SemanticTokensLegend, _onDidChangeEvent?: Event<void>): monaco.languages.DocumentRangeSemanticTokensProvider;
