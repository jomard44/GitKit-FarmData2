...
export declare class AuthenticationMainImpl implements AuthenticationMain {
    ...
    protected selectSession(providerId: string, providerName: string, extensionId: string, extensionName: string, potentialSessions: Readonly<AuthenticationSession[]>, scopeListOrRequest: ReadonlyArray<string> | theia.AuthenticationWwwAuthenticateRequest, clearSessionPreference: boolean): Promise<theia.AuthenticationSession>;
