...
import { SelectableTreeNode, StatefulWidget } from '@theia/core/lib/browser';
...
export declare class PreferencesEditorWidget extends BaseWidget implements StatefulWidget {
    ...
    protected doResetScroll(nodeIDToScrollTo?: string, filterWasModified?: boolean): void;
