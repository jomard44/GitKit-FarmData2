...
export declare class BreakpointManager extends MarkerManager<SourceBreakpoint> {
    ...
    readonly onDidChangeDataBreakpoints: import("@theia/core/lib/common").Event<DataBreakpointsChangeEvent>;
    ...
    updateDataBreakpoint(id: string, options: {
        enabled?: boolean;
...
export declare function diff<T>(prevs: T[], nexts: T[], toKey: (member: T) => string): {
    added: T[];
    removed: T[];
    changed: T[];
};
