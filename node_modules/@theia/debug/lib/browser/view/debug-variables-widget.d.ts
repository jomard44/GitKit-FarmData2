...
export declare class DebugVariablesWidget extends SourceTreeWidget {
    ...
    protected readonly statePerSession: Map<string, DebugVariablesWidgetSessionState>;
    protected init(): void;
...
export declare class DebugVariablesWidgetSessionState {
    protected readonly statePerStackFrame: Map<string, object>;
