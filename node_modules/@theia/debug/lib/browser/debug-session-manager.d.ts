import { CommandService, DisposableCollection, Emitter, Event, MessageService, ProgressService, WaitUntilEvent } from '@theia/core';
...
export declare class DebugSessionManager {
    ...
    getDataBreakpoints(session?: DebugSession | undefined): DebugDataBreakpoint[];
